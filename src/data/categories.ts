...
export const CATEGORIES: Category[] = [
  {
    ...
    icon: '🏃',
    sampleWords: ['sprint', 'backlog', 'standup', 'velocity', 'story points'],
    words: [
  ...
  },
  {
    ...
    icon: '💼',
    sampleWords: ['synergy', 'leverage', 'circle back', 'bandwidth', 'deep dive'],
    words: [
  ...
  },
  {
    ...
    icon: '💻',
    sampleWords: ['API', 'microservices', 'kubernetes', 'code review', 'pull request'],
    words: [
